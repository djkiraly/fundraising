      ...
      <div className="p-4 space-y-4">
        ...
        {summary && (
          <div className={`p-4 rounded-lg border ${
            ...
            {summary.emailConfigured !== undefined && (
              <div className="mt-2 pt-2 border-t border-green-200 flex items-center gap-2">
                <Mail className="w-4 h-4 text-green-600" />
                <span className="text-sm">
                  {summary.emailConfigured ? (
                    <>
                      {summary.emailsSent} email(s) sent
                      {summary.emailsFailed && summary.emailsFailed > 0 && (
                        <span className="text-yellow-600 ml-1">
                          ({summary.emailsFailed} failed)
                        </span>
                      )}
                    </>
                  ) : (
                    <span className="text-yellow-600">
                      Email not configured - no password setup emails sent
                    </span>
                  )}
                </span>
              </div>
                        ...
                        <td className="px-4 py-2">
                          {result.success ? (
                            result.emailSent ? (
                              ...
                              <span className="inline-flex items-center gap-1 text-yellow-600 text-sm" title={result.emailError}>
